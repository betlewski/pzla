...
@Component({
  selector: 'app-edit-training-group',
  templateUrl: './edit-training-group.component.html',
  styleUrls: ['./edit-training-group.component.css']
})
export class EditTrainingGroupComponent implements OnInit {
