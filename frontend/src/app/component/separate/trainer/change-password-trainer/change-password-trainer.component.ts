...
@Component({
  selector: 'app-change-password-trainer',
  templateUrl: './change-password-trainer.component.html',
  styleUrls: ['./change-password-trainer.component.css']
})
export class ChangePasswordTrainerComponent implements OnInit {
  ...
  public changePwd() {
    if (this.checkIfDataNotEmpty()) {
      if (this.checkIfNewPasswordsEquals()) {
        this.trainerService.changePassword(this.oldPassword, this.newPassword1)
          .subscribe(() => {
