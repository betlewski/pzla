package com.project.webapp.sportmanager.security.controller;

import com.project.webapp.sportmanager.security.model.JwtRequest;
import com.project.webapp.sportmanager.security.model.JwtResponse;
import com.project.webapp.sportmanager.security.service.JwtUserDetailsService;
import com.project.webapp.sportmanager.security.utils.JwtTokenUtil;
...
public class JwtAuthenticationController {
    ...
    @GetMapping(value = "/rest/activate/athlete")
    public void canActivateAthlete() {
    }

    @GetMapping(value = "/rest/activate/trainer")
    public void canActivateEmployeeTrainer() {
    }

    @GetMapping(value = "/rest/activate/club")
    public void canActivateClub() {
    }
